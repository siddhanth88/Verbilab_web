    ...
    <section id="solutions" ref={sectionRef} className="section-pad">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
        {CARDS.map(({ icon: Icon, title, body }) => (
          <article
            key={title}
            className="wwd-reveal card-glow rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-8 transition-all duration-300 hover:-translate-y-1 hover:border-[rgba(77,255,164,0.3)] hover:shadow-[0_20px_40px_rgba(0,0,0,0.4)]"
          >
