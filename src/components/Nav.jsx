    ...
    <>
      ...
      >
        <div className="nav-premium-inner">
          <a href={homeHref} className="nav-logo nav-logo--left" aria-label="Verbilab AI home">
          ...
          <nav className="nav-links hidden md:flex" aria-label="Main navigation">
            ...
            {LINKS.map((link) => (
              ...
              <a key={link.href} href={linkHref(link.href)} className="nav-link">
          ...
          <div className="nav-premium-actions">
